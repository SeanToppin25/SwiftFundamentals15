...
let weightliftingChallenges: [String] = ["Lift weights 3 times a week", "Bench press your body weight"]
...
let challenges: [[String]] = [walkingChallenges, runningChallenges, weightliftingChallenges]
