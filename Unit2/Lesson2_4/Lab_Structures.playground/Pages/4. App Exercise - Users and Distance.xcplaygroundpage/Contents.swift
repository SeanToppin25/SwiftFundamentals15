...
var Sean = User(name: "Sean Toppin", age: 21, height: 70.0, weight: 160.0, activityLevel: 7)
print("User: \(Sean.name), Age: \(Sean.age), Height: \(Sean.height) inches, Weight: \(Sean.weight) lbs, Activity Level: \(Sean.activityLevel)")
...
print("Distance in feet: \(shortRun.feet), Distance in meters: \(shortRun.meters)")
