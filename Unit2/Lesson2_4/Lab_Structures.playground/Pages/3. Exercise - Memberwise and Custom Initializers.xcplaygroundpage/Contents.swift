...
let favoriteBook = Book(title: "The Hobbit", author: "J.R.R. Tolkien", pages: 310, price: 10.99)
...
let laptopOne = Laptop(yearPurchased: 2020)
let laptopTwo = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2021)

print(laptopOne.screenSize, laptopOne.repairCount, laptopOne.yearPurchased)
print(laptopTwo.screenSize, laptopTwo.repairCount, laptopTwo.yearPurchased)
